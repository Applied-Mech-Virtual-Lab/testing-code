...
function step3_1()
{
	...
	document.getElementById('weight2').style.left = "510px";
...
function step6_1()
{
	...
	document.getElementById('weight5').style.left = "510px";
...
{
	myStopFunction();
	document.getElementById('weight6').style.left="510px";
...
function step7_1()
{
	...
	document.getElementById('weight6').style.left = "520px";
